...
public class SalesMilestoneService{
 private static final BigDecimal STEP=new BigDecimal("7000.00"); private final RestaurantOrderRepository orders; private final SalesMilestoneRepository milestones;
