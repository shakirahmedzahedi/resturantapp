...
('N010','Buut + Piyaju','বুট + পিয়াজু',30.00,16,TRUE),
('N011','Pudding','পুডিং',30.00,11,TRUE),
('N012','Coke','কোক',20.00,12,TRUE),
('N013','Roll','রোল',30.00,10,TRUE),
('N014','Aam Vorta','আম ভর্তা',30.00,23,TRUE),
('N015','Red Bull','রেড বুল',40.00,15,TRUE),
('N016','Halim','হালিম',60.00,25,TRUE),
('N017','Aam Sotto','আমসত্ত্ব',30.00,26,TRUE),
('N018','Juice','জুস',15.00,18,TRUE),
('N019','Tehari','তেহারি',100.00,28,TRUE),
('N020','Dohi Bara','দই বড়া',40.00,14,TRUE),
('N021','Popcorn','পপকর্ন',20.00,21,TRUE),
('N022','Chitoi','চিতই',25.00,13,TRUE),
('N023','Achar','আচার',80.00,29,TRUE),
('N024','Cap Cake','কাপকেক',25.00,24,TRUE),
('N025','Jhal Muri','ঝাল মুড়ি',30.00,19,TRUE),
('N026','Korv Bread','করভ ব্রেড',20.00,17,TRUE),
('N027','Candy packet','ক্যান্ডি প্যাকেট',20.00,27,TRUE),
('N028','Chicken Sharma',' চিকেন শর্মা',60.00,22,TRUE),
('N029','Chicken Nuggets','চিকেন নাগেটস',50.00,20,TRUE),
